...
function CastCatForm() local localObj = GetLocalPlayer(); if (not localObj == nil) and (not localObj == 0) then if (not IsShapeshift()) and if (HasSpell("Cat Form")) and (not IsSpellOnCD("Cat Form")) then CastSpellByName("Cat Form"); return true; end end return false; end
